...
public class OneDimensionalArray {
	public static void main(String[] args) {
		...
		System.out.println("인덱스 범위를 벗어나는 경우, ArrayIndexOutOfBoundsException이 발생합니다.");
		
		
		// Q. int형 배열 grade2를 선언하고, 동시에 70, 80, 90이 저장되도록 코드를 작성해 봅시다.
		//    2가지 방식으로 작성해 봅시다.
		int[] grade2 = new int[] {20, 80, 90}; // 첫 번째 방법.
		int[] grade3 = {20, 80, 90}; // 두 번째 방법.
