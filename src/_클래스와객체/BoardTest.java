...
public class BoardTest {
	...
	public static void main(String[] args) {
		...
		User2 user1 = new User2(0, "ssafy", "1234", "김싸피", "김싸피", "ssafy@ssafy.com");
		User2 user2 = new User2(1, "hong", "123", "홍싸피", "김싸피", "hong@ssafy.com");
		User2 user3 = new User2(2, "samsic", "samsic", "김삼식", "김싸피", "kim@ssafy.com");
		User2 user4 = new User2(3, "happy", "happy", "김싸피", "이싸피", "lee@ssafy.com");
